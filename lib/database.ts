...
class Database {
  ...
  private async init() {
    ...
    const defaultModules = [
      { name: "YouTube Automation", description: "Automatisierte YouTube-Aktionen", script_path: "youtube-bot.py" },
      {
        name: "Instagram Automation",
        description: "Automatisierte Instagram-Aktionen",
        script_path: "instagram-bot.py",
      },
      { name: "Email Automation", description: "Automatisierte E-Mail-Verarbeitung", script_path: "email-bot.py" },
      { name: "Web Scraper", description: "Automatisiertes Web-Scraping", script_path: "web-scraper.py" },
    ]
